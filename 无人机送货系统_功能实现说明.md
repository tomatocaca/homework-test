...
void adminShowReport() {
    ...
    int busyDrones = 0;
    for (auto& d : lightDrones)   if (d.getDroneState() != Idle) busyDrones++;
    for (auto& d : mediumDrones)  if (d.getDroneState() != Idle) busyDrones++;
    for (auto& d : heavyDrones)   if (d.getDroneState() != Idle) busyDrones++;
    cout << "\n--- 无人机使用情况 ---" << endl;
